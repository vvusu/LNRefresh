#
#  Be sure to run `pod spec lint LNTheme.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #s.screenshots  = "https://github.com/wedxz/LNRefresh/blob/master/images/demo_1.gif", "https://github.com/wedxz/LNRefresh/blob/master/images/demo_2.gif"
  ...
  # Or just: s.author    = "wedxz"
  # s.authors            = { "wedxz" => "wedxzl@gmail.com" }
  # s.social_media_url   = "http://twitter.com/wedxz"
